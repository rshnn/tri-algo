...
public class LinearModel {
   ...
   */
  public LinearModel(LinearObjectiveFunction linearObjectiveFunction) {
    this.objectiveFunction = linearObjectiveFunction;
   ...
   * 
   * @param linearEquation The {@link LinearEquation} to add to the model.
   */
  public void addConstraint(LinearEquation linearEquation) {
    if (linearEquation.getCoefficients().getDimension() != getNumVariables()) {
      throw new IndexOutOfBoundsException();
    }
    constraints.add(linearEquation);
  }
